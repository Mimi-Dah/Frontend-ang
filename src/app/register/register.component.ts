...
export class RegisterComponent implements OnInit{
  ...
  credentials = {username: '',nom_autorite:'' ,contact: '',email:'',adresse_autorite:'' };
  ...
  sendLoginCode() {
    ...
    this.firebaseAuth.signInWithPhoneNumber(num, appVerifier)
            .then((result: any) => {
                ...
                localStorage.setItem('usernom', this.credentials.username);
                localStorage.setItem('nom_autorite', this.credentials.nom_autorite);
                localStorage.setItem('userphone', phoneNumberWithoutCountryCode);
                localStorage.setItem('email', this.credentials.email);
                localStorage.setItem('adresse_autorite', this.credentials.adresse_autorite);
                setTimeout(() => {
